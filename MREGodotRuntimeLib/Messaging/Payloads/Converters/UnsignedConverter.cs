...
namespace MixedRealityExtension.Messaging.Payloads.Converters
{
	...
	public class UnsignedConverter : JsonConverter
	{
		...
		{
			return MixedRealityExtension.Util.UtilMethods.GetActualType(objectType) == typeof(UInt32);
		}
		...
		public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
		{
			...
			{
				Godot.GD.Print($"Failed to deserialize {reader.ValueType} {reader.Value}");
				return null;
			}
		}
