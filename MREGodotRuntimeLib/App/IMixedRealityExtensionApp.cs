...
namespace MixedRealityExtension.App
{
	...
	public interface IMixedRealityExtensionApp
	{
		...
		void UserJoin(Node userGO, IHostAppUser hostAppUser, bool isLocalUser);

		/// <summary>
		/// User is leaving the app.
		/// </summary>
		/// <param name="userGO">The game object that serves as the user in unity.</param>
		void UserLeave(Node userGO);
...
/*FIXME
		...
		/// </summary>
		/// <param name="objects">An array of Nodes that this MRE should be aware of. Nodes cannot already be owned by an MRE.</param>
